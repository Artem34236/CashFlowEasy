    ...
    >
      ...
      <div className="px-2 sm:px-6">
        ...
        <div className="flex items-center justify-between textColor px-3 py-2 min-h-[40px] w-full rounded-md mt-2">
          <p className="text-sm font-medium max-w-[150px] w-full text-center">Имя</p>
          <p className="text-sm font-medium max-w-[150px] w-full text-center">Категория</p>
          <p className="text-sm font-medium max-w-[150px] w-full text-center">Дата</p>
          <p className="text-sm font-medium max-w-[150px] w-full text-center">Цена</p>
          <p className="text-sm font-medium max-w-[150px] w-full text-center">Количество</p>
        </div>
        ...
        <div className="flex flex-col gap-3 mt-3">
          ...
          <div className="flex text-blue-700 secondBg items-center justify-between textColor px-3 py-2 min-h-[40px] w-full rounded-md mt-2">
            <p className="text-sm font-medium max-w-[150px] w-full text-center">кола</p>
            <p className="text-sm font-medium max-w-[150px] w-full text-center">Напитки</p>
            <p className="text-sm font-medium max-w-[150px] w-full text-center">12.08.2024</p>
            <p className="text-sm font-medium max-w-[150px] w-full text-center">1995</p>
            <p className="text-sm font-medium max-w-[150px] w-full text-center">1</p>
          </div>
        </div>
      </div>
    </div>
