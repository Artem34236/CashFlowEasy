...
export default function Home() {
  return (
    <div className="bg-[#0e0f0f] xl:py-[50px] 2xl:mt-[106px] xl:mt-[82px] pb-[20px] md:mt-[66px] mt-[54px]">
      {/* Секция 1  */}
      ...
      <div className="mx-auto max-w-[1200px] sm:p-0 px-[10px]">
        <div className="flex items-center justify-between xl:max-w-[500px] md:max-w-[400px] max-w-[300px] mx-auto xl:mt-[140px] md:mt-[100px] mt-[50px] mb-[70px]">
          <img src="/svg/leftPetalBlue.svg" alt="" />
          <p className="xl:text-[42px] md:text-[34px] text-[28px] font-[400] a text-white pt-[14px]">
            CASHFLOWEASE
          </p>
          <img src="/svg/rightPetalBlue.svg" alt="" />
        </div>

        <div className="flex md:flex-row flex-col items-center justify-between md:px-[85px] mb-[50px] gap-5">
          <div className="max-w-[415px] b ">
            <h3 className="xl:text-[26px] text-[24px] font-[500] mb-[16px] text-[#F4631A]">
              Планирование бюджета
            </h3>
            <p className="xl:text-[20px] text-[18px] font-[400] text-white leading-[28px]">
      ...
      <div className="mx-auto max-w-[1200px] md:px-0 px-[10px]">
        ...
        <div className="flex items-center justify-between xl:max-w-[500px] md:max-w-[400px] max-w-[300px] mx-auto xl:mt-[140px] md:mt-[100px] mt-[50px] mb-[50px]">
          ...
          />
          <p className="xl:text-[42px] md:text-[34px] text-[24px] font-[400] text-white text-center">
            Что вы получите?
          </p>
          <img
        ...
        <div className="max-w-[1300px] w-full mx-auto grid md:grid-cols-3 gap-3 md:gap-6 text-center">
          {/* Левая колонка */}
          <div className="bg-[#F4631A] text-white rounded-[8px] px-[20px] py-[30px] flex items-center justify-center text-[14px] sm:text-[18px] md:text-[22px] xl:text-[28px] leading-snug">
      ...
      <div className="mx-auto max-w-[1200px] px-[10px] flex flex-col md:flex-row-reverse items-center justify-between gap-10 mt-[120px] md:mt-[180px] lg:mt-[220px] 2xl:mt-[250px]">
        ...
        <div className="max-w-[775px] text-center md:text-left">
          <h3 className="text-[#F4631A] font-[500] text-[26px] md:text-[32px] lg:text-[36px] mb-[10px] leading-snug">
            Готовы взять финансы под контроль?
          </h3>

          <p className="text-white font-[400] md:font-[500] text-[20px] md:text-[24px] lg:text-[28px] mb-[40px] md:mb-[60px] leading-relaxed">
          ...
          <div>
            <Link
              href={"/login"}
              className="inline-block text-white text-[18px] md:text-[20px] lg:text-[22px] font-[500] hover:bg-[#d95214] transition-all duration-300 bg-[#F4631A] py-[12px] px-[32px] md:px-[38px] rounded-[6px] shadow-md"
            >
              Начнём?
            </Link>
          </div>
